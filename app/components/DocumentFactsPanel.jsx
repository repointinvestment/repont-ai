  ...
  return (
    <div style={embedded ? { padding: '4px 28px 20px' } : { background: '#fff', borderRadius: 14, padding: '22px 28px', marginBottom: 24, boxShadow: '0 2px 12px rgba(0,0,0,0.05)' }}>
      ...
      <p style={{ fontSize: 11, color: '#B0AEA5', margin: '12px 0 0' }}>
        * 업력은 사업자등록증명의 사업자등록일 기준으로 자동 반영됩니다(서류 없으면 등록 때 입력한 값 사용). 업종은 CRM이 분류형(도소매업 등)이고 서류는 세부 업태/종목이라 자동 비교하지 않습니다. 직원 수·기존 대출 잔액·스마트기기 등은 서류에 없어 진단 입력값을 그대로 씁니다.
      </p>
    </div>
  );
}
